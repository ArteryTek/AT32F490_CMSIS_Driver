...
#if !defined (AT32F490RCT7)

    #error "Please select first the target device used in your application (in at32f490.h file)"
#endif
...
/**
  * @brief at32f490 standard peripheral library version number
  */
#define __AT32F490_LIBRARY_VERSION_MAJOR    (0x02) /*!< [31:24] major version */
#define __AT32F490_LIBRARY_VERSION_MIDDLE   (0x00) /*!< [23:16] middle version */
#define __AT32F490_LIBRARY_VERSION_MINOR    (0x04) /*!< [15:8]  minor version */
#define __AT32F490_LIBRARY_VERSION_RC       (0x00) /*!< [7:0]  release candidate */
#define __AT32F490_LIBRARY_VERSION          ((__AT32F490_LIBRARY_VERSION_MAJOR << 24)  | \
                                             (__AT32F490_LIBRARY_VERSION_MIDDLE << 16) | \
                                             (__AT32F490_LIBRARY_VERSION_MINOR << 8)   | \
                                             (__AT32F490_LIBRARY_VERSION_RC))
...
/**
  * @brief at32f490 interrupt number definition, according to the selected device
...
#include "at32f490_def.h"
#include "at32f490_conf.h"
